...
ActiveRecord::Schema[7.2].define(version: 2020_09_20_211149) do
  create_table "audio_features_syncs", force: :cascade do |t|
    t.datetime "completed_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "playlist_sync_id", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "spotify_credential_expires", default: false, null: false
